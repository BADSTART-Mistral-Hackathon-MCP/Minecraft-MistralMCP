...
export function createSentinelController(gateway: BotGateway) {
  return {
    // Enable sentinel protection mode
    async enableSentinel(req: Request, res: Response) {
      try {
    ...
    async disableSentinel(req: Request, res: Response) {
      try {
    ...
    // Set zone defense
    async setZoneDefense(req: Request, res: Response) {
      try {
    ...
    async getCurrentPosition(req: Request, res: Response) {
      try {
    ...
    // Get sentinel status
    async getSentinelStatus(req: Request, res: Response) {
      try {
    ...
    async updateSentinelSettings(req: Request, res: Response) {
      try {
    ...
    async quickProtect(req: Request, res: Response) {
      try {
