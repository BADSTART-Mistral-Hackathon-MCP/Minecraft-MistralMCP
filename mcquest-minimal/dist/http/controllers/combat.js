...
export function createCombatController(gateway) {
    return {
        // Enable combat mode
        async enableCombat(req, res) {
            try {
        ...
        async enableAggressiveMode(req, res) {
            try {
        ...
        async enableRetaliationMode(req, res) {
            try {
        ...
        async updateCombatSettings(req, res) {
            try {
